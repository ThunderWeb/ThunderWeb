...
<?php include 'elements/carousel/carousel.php'; ?><!--/carousel-->
        ...
        <div class="row">
            <div class="col-sm-8">
                <div class="media contact-info wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="600ms">
                    ...
                    <div class="media-body">
                        <h2>Имате въпрос или нужда от персонализирано решение?</h2>
                        <p>Ако имате конкретно запитване или просто желаета да обсъдим вашият бъдещ проект, ща се
                            радваме да се свържете с нас +0123 456 70 80</p>
                    </div>
                </div>
            </div>
        </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        $('li').click(function () { /* click */
            ...
            childEl.attr('class', ''); /* class for all */
            $(this).attr('class', 'active'); /* change the class for the current */
        }
